    ...
    <div className="w-full bg-gray-50 dark:bg-gray-900 flex-grow">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          {/* Левая колонка: Посты */}
          <div
            className={`lg:col-span-2 space-y-8 transition-opacity duration-300 ${
          ...
          >
            ...
            {posts.length > 0 ? (
              posts.map((post) => (
                <div
                  key={post.id}
                  className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden transition-shadow hover:shadow-lg"
                >
                  <div className="p-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 text-center">
                <p className="text-gray-600 dark:text-gray-300">
                  В этой рубрике пока нет постов.
                </p>
              </div>
            )}
          </div>
